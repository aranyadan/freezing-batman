...
cv::Mat LaneDetector::inversePerspectiveTransform(cv::Mat &image) {
    my_ipt_offsets_file ="/home/kinoder/catkin_ws/src/freezing-batman/environment/interpretation/lane_detector/data/" +  ipt_offsets_file;
    ...
    if (debug_mode == 5 && !done) {
        ...
        if (!read_parameters) {
            ...
            int status = 1;
            FILE* ipt_data = fopen(("/home/kinoder/catkin_ws/src/freezing-batman/environment/interpretation/lane_detector/data/"+warp_matrix_file).c_str(), "r");
